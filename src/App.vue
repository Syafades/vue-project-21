      ...
      <footer class="py-3">
        <div class="row">
          <div class="col-6 col-md-4 mb-3 ">
            ...
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                </svg><a href="mailto:dperfum@gmail.com" class="p-2  "
                  style="color: white; font-family:'Fauna One',serif; ">dperfum@gmail.com</a></li>
          ...
          <div class="col-6 col-md-2 mb-3">
            <h5 style="font-weight: bolder ;">HELP</h5>
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">Terms of Service</a>
              </li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">Privacy Policy</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">Shipping Policy</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">Return Policy</a></li>
            </ul>
          </div>

          <div class="col-6 col-md-2 mb-3">
            <h5 style="font-weight: bolder ;">SHOP</h5>
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">Best Sellers</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">New Products</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">Woman</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">Man</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 "
                  style="color: white;  font-family: 'Fauna One', serif;">FAQs</a></li>
            </ul>
          </div>
          ...
          <div class="col-md-3 offset-md-1 mb-2">
            <form>
              ...
              <div class="d-flex flex-column  w-100 ">
                <label for="newsletter1" class="visually-hidden" style="font-family: 'Fauna One', serif;">Your
                  Email</label>
                <input id="newsletter1" type="text" class="form-control" placeholder="Your Email">
                <button class="btn btn-primary" type="button" style="font-family: 'Fauna One', serif;">Join
                  Us</button><br>
                <div class="col-md-5 md-1 mb-3">
                  ...
                  <ul class="list-unstyled d-flex">
                    ...
                    <li class="ms-3"><a class="link-dark" href="www.instagram.com"><svg
                    ...
                    <li class="ms-3"><a class="link-dark" href="www.facebook.com"><svg
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between  border-top">
          <p style="font-family: 'Fauna One', serif;">Copyright © 2022 D’Perfum</p>
          <ul class="list-unstyled d-flex">
            <li class="ms-3" style="font-family: 'Fauna One', serif;">
              <p>JL Patal Senayan No. 25, Kebayoran Lama, 12210</p>
              <p class="float-end"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                    fill="white" class="bi bi-arrow-bar-up" viewBox="0 0 16 16">
