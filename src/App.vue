        ...
        <div class="row">
          <div class="col-6 col-md-4 mb-3 ">
            ...
            <ul class="nav flex-column">
              <li class=" mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <div class="d-flex flex-column  w-100 ">
                ...
                <div class="col-md-5 md-1 mb-3">
                  ...
                  <ul class="list-unstyled d-flex">
                    <li class=""><a class="link-dark" href="https://twitter.com" target="_blank"><svg
                    ...
                    <li class="ms-3"><a class="link-dark" href="https://instagram.com" target="_blank"><svg
                    ...
                    <li class="ms-3"><a class="link-dark" href="https://facebook.com" target="_blank"><svg
                    ...
                    <li class="ms-3"><a class="link-dark" href="https://youtube.com" target="_blank"><svg
